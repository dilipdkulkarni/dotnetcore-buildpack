...
[![Actions Status](https://github.com/dilipdkulkarni/dotnetcore-buildpack/workflows/main/badge.svg)](https://github.com/dilipdkulkarni/dotnetcore-buildpack/actions)
...
```
heroku buildpacks:set dilipdkulkarni/dotnetcore
```

### .NET Core edge

```
heroku buildpacks:set https://github.com/dilipdkulkarni/dotnetcore-buildpack
```

### .NET Core Preview release

```
heroku buildpacks:set https://github.com/dilipdkulkarni/dotnetcore-buildpack#preview
```

### Previous releases

```
heroku buildpacks:set https://github.com/dilipdkulkarni/dotnetcore-buildpack#version
```

Available [releases](https://github.com/dilipdkulkarni/dotnetcore-buildpack/releases)
...
[ASP.NET Core Demo App](https://github.com/dilipdkulkarni/AspNet5DemoApp)
